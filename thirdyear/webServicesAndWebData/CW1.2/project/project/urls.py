...
from app.views import HandleRegisterRequest, HandleLoginRequest, HandleLogoutRequest, HandleListRequest, HandleViewRequest, HandleAverageRequest, HandleRateRequest
urlpatterns = [
